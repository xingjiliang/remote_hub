...
tf.app.flags.DEFINE_integer('day_grained_cell_size', 15, 'day_grained_cell_size')
...
tf.app.flags.DEFINE_integer('hour_grained_cell_size', 5, 'hour_grained_cell_size')
...
tf.app.flags.DEFINE_integer('fcn_hidden_layer_size', 10, 'fcn_hidden_layer_size')
