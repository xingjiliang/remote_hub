...
tf.app.flags.DEFINE_float('learning_rate', 100, 'learning rate')
...
tf.app.flags.DEFINE_integer('day_grained_cell_size', 50, 'day_grained_cell_size')
...
tf.app.flags.DEFINE_integer('hour_grained_cell_size', 20, 'hour_grained_cell_size')
...
tf.app.flags.DEFINE_integer('fcn_hidden_layer_size', 50, 'fcn_hidden_layer_size')
