...
class Model:
    def __init__(self, model_settings, is_training=False):
        ...
        with tf.variable_scope("day_grained_processing_frame"):
            ...
            day_grained_forward_lstm_cell = tf.nn.rnn_cell.LSTMCell(model_settings.day_grained_cell_size, use_peepholes=True, state_is_tuple=True)
            day_grained_backward_lstm_cell = tf.nn.rnn_cell.LSTMCell(model_settings.day_grained_cell_size, use_peepholes=True, state_is_tuple=True)
        ...
        with tf.variable_scope("hour_grained_processing_frame"):
            ...
            hour_grained_forward_lstm_cell = tf.nn.rnn_cell.LSTMCell(model_settings.hour_grained_cell_size, use_peepholes=True, state_is_tuple=True)
