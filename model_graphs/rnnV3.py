...
class ModelSettings:
    ...
    hour_grained_cell_size = 20
    hour_per_day_size = 24
    hour_per_day_embedding_size = 10
    is_today_size = 2
    is_today_embedding_size = 5
    fcn_layer_nums = 1
...
class Model:
    def __init__(self, is_training=False):
        ...
        with tf.variable_scope("hour_grained_processing_frame"):
            self.hour_per_day = tf.placeholder(dtype=tf.int32,
                                               shape=[None,
            ...
            self.hour_per_day_embedding = tf.get_variable(name='hour_per_day_embedding',
                                                          shape=[model_settings.hour_per_day_size,
                                                                 model_settings.hour_per_day_embedding_size],
                                                          dtype='float64')
            ...
            self.hour_grained_inputs = tf.concat(
                values=[
                    ...
                    tf.nn.embedding_lookup(self.is_today_embedding, self.is_today),
